...
planet_img = pygame.image.load('assets/textures/red_planet_2.png').convert_alpha()
planet_img = pygame.transform.rotozoom(planet_img, 0, 1.5).convert_alpha()
projectile_img = pygame.image.load('assets/textures/projectile.png').convert_alpha()
projectile_img = pygame.transform.rotozoom(projectile_img, 0, 2.6)
